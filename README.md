...
**Goal:** Demonstrate skills in manual testing, test design, Git, Jira, HTTP, DevTools, and Agile basics
...
- [Video player (w3schools) – 5 cases](Checklists_Test-cases/test_cases_video_player.md)
- [Yandex Maps – 5 cases](Checklists_Test-cases/test_cases_maps.md)
...
- [File upload (postimages.org) checklist](Checklists_Test-cases/checklist_file_upload.md)
...
- [Test design techniques](theory_examples.txt) (equivalence partitioning, boundary values)
